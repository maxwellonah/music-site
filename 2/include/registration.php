    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-body bg-pri">
                <button id="closemodalbtn4" type="button" class="btn-close" data-bs-dismiss="modal"
                        ...
                        <form action="include/register.php" method="post" id="">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input name="email" class="form-control me-2" type="email"
                                        placeholder="Type Your Email @" aria-label="Email" required>
                                </div>
                                <div class="col-md-6">
                                    <p>Create A Username</p>
                                    <input name="username" class="form-control me-2" type="text"
                                        placeholder="Type Your Username" aria-label="text" required>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-md-6">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 text-center">
                                    <button name="register" class="btn btn-light mt-3 rounded-pill"
                                        style="width: 150px;" type="submit">REGISTER</button>
                                </div>
                            </div>
                        </form>
                    </section>
